...
const TicketPage = () =>
{
  ...
  useEffect(() => {
    const fetchEventDetails = async () => {
      try {
        const response = await fetch(`https://8080-aeddeaafbfdbbcbfcaaafaebabceaeaadbdbabf.project.examly.io/event/${id}`,{
          method: 'GET',
          headers:
           {
    ...
    const fetchAttendeeDetails = async () => {
      try {
        const response = await fetch(`https://8080-aeddeaafbfdbbcbfcaaafaebabceaeaadbdbabf.project.examly.io/attendee/attendee/${aid}`,
        {
          method: 'GET',
          headers:
           {
