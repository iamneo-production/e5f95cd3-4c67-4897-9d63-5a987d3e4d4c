...
const TicketPage = () =>
{
  ...
  useEffect(() => {
    ...
    const fetchAttendeeDetails = async () => {
      try {
        const response = await fetch(`https://8080-ceabacddbcbfcaaafaebabcddfaadfadc.project.examly.io/attendee/attendee/${aid}`,
        {
          method: 'GET',
          headers:
           {
    ...
    const fetchTicketDetails = async () => {
      try {
        const response = await fetch(`https://8080-ceabacddbcbfcaaafaebabcddfaadfadc.project.examly.io/ticket/ticket/${tid}`,{
          method: 'GET',
          headers:
           {
            'Content-Type': 'application/json',
