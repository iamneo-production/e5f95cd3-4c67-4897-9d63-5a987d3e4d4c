...
function PaymentPage () 
{
  ...
  const handleSubmit = (event) => {
    ...
    console.log(payment)
    fetch("https://8080-cbbfabdedecbfcaaafaebabceaeaadbdbabf.project.examly.io/payment/save",{
      method:"POST",
      headers:
      {
  ...
  const handleTicket = () => {
    ...
    fetch('https://8080-cbbfabdedecbfcaaafaebabceaeaadbdbabf.project.examly.io/ticket', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${token}`,
  ...
  const updateTicketCount = (eventid,count) => {
    fetch(`https://8080-cbbfabdedecbfcaaafaebabceaeaadbdbabf.project.examly.io/event/tickets/${eventid}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${token}`,
